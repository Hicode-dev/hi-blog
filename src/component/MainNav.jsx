         ...
         <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64  text-white  h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-black dark:bg-gray-800">
               <ul className="space-y-2">
                  <li> <Link to={"/home"} >
                     <a href="#" className="flex items-center p-2 text-base font-normal text-gray-300 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700" >
                  ...
                  <li> <Link to={'/series'}>
                     <a href="#" className="flex items-center p-2 text-base font-normal text-gray-300 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <span className="flex-1 ml-3 whitespace-nowrap">series</span>
